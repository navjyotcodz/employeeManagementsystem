...
if(isset($_REQUEST['done'])){
  ...
  $type_act=$_REQUEST['type_act'];
    ...
    if ($mode == 'add')
    {
       ...
       echo $sql= "INSERT INTO actform(`act_category`, `short_title`,`description`, `applicability`,`wef`, `state`,`act_industry`,`file_name`,`type_act`) VALUES ('$category', '$title','$description', '$applicability','$date','$state','$industry_string','$target_file', '$type_act')";
